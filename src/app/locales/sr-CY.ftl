...
#
install_from_chrome_store = Инсталирајте из Chrome продавнице проширења
chrome_store_short = Chrome продавница проширења
install_from_ms_edge_store = Инсталирајте из Microsoft Edge продавнице проширења
ms_edge_store_short = MS Edge продавница
install_from_github = Инсталирајте из изворног кода (GitHub)

#
# Main info
#
info_top1 =
    Помоћи ће вам у учењу и разумевању страних језика и пружиће превод изабраног текста <b>у реалном времену</b>
    из <b>HTML-a</b> или <b>PDF докумената</b>, па чак омогућава <b>превод целокупног текста на веб-страници</b>.

info_top2 =
    Преводите преко 100 страних језика на ваш матерњи језик директно на веб-сајту који читате или
	унесите текст у главни прозор проширења да бисте добили <b>тренутни превод</b>.

gallery_website_popup = Добијате превод у контексту веб-странице, подразумевани искачући прозор
gallery_website_select_text = Различити начини за превођење изабраног текста, нпр. кликом на иконицу [X] у близини
gallery_website_translation_results = Прилагођен искачући прозор са иконицама за акције (С лева на десно: Текст у говор, Сачувај у омиљено, Копирај превод, Следећи превод)
gallery_app_settings = Подесите проширење
gallery_app_popup_customization = Подесите тему, прилагодите искачући прозор за превод, изаберите локализацију
gallery_app_translate_tab = Унесите текст и добијате превод у главном прозору апликације
gallery_app_history_tab = Историја превода са опцијама за import/export у JSON формату
gallery_pdf_translation = Преведите страни текст из PDF фајлова
gallery_app_theme_dark = Тамна тема за прозор апликације

install_extension_header = Инсталирајте проширење
install_chrome_store = Chrome продавница проширења
install_ms_addons = Microsoft Edge додаци
install_firefox = Firefox додаци
install_old_version = Инсталирајте стару верзију са ограниченом подршком
install_from_sources = Инсталирајте из изворног кода

vendors_available_header = Доступни преводиоци
...
# Free-features info:
#
features_free_header = <b>Бесплатне функционалности</b> укључене у <em>{-app-brand-name}</em> проширење:
...
# Paid-features info:
#
features_paid_header = Про функционалности (плаћена претплата, очекује се 2025.):
features_paid_full_pro_page_ai = Добијање превода целе странице користећи AI технологије, нпр. OpenAI <em>(плаћање по коришћењу)</em>
features_paid_voice_over = Употреба гласовог input-а или препознавања говора за добијање превода текста
features_paid_multi_popup_results = Истовремено добијање превода од свих преводиоца
features_paid_more_interactivity = Више интеракција са искачућим прозором за превод на веб-страницама (нпр. превлачење, pin-овање, промена величине, итд.)
...
openai_access_adjust_limits = Не заборавите да подесите ограничења у подешавањима <em>(препоручено)</em>
...
# Footer
#
footer_info = Направљено са љубављу и уз помоћ open-source пројеката. Подржите бесплатну верзију донацијом путем <a href="https://www.paypal.me/romanesca" target="_blank">PayPal-а</a>.


#
# Other
#
supported_localization_header = Подржане локализације
...
total_rating_users_globe = <b>{$usersCount}</b> корисника <em>(из обе продавнице, Chrome и Edge)</em>
