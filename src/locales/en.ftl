...
plans_pro_title = PRO (monthly subscription / ⭐ most popular)
...
free_plan_tts = Text-to-speech with Google Translate API and the browser’s built-in speech-synthesis engine
...
pro_plan_tokens_note = (≈ 750K words ≈ 1,000–1,500 book pages ≈ 3,000 web pages)
...
features_icon = Select text and click the translation icon that appears nearby (X)
...
features_input_tab = Type your text in the app’s “Translate” tab (extension action-window); we recommend setting a hotkey at { $shortcuts_url }
...
features_customize = Adjust the translation popup design — font size, colors, etc.
