...
gallery_website_select_text = 获取选中文本翻译的多种方式，例如点击 [X] 图标
gallery_website_translation_results = 自定义翻译弹窗（语音播放、收藏、复制翻译、下一条翻译）
gallery_app_settings = 应用基础设置
gallery_app_popup_customization = 自定义主题、翻译弹窗及界面语言
gallery_app_translate_tab = 在主窗口输入文本并即时翻译
...
features_icon = 选中文本后点击旁边出现的翻译图标 (X)
